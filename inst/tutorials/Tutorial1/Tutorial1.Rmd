...
```{r, include=FALSE}
data_election=read.csv('election_one.csv')
data_election_one=read.csv('data_election_1.csv')
data_usa_one=read.csv('election_usa.csv')
data_usa=read.csv('election_usa_1.csv')
```
